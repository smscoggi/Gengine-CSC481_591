...
var cellWidth = 20;
var cellHeight = 20;
var xcellCount = canvas.width/cellWidth;
var ycellCount = canvas.height/cellHeight;
var direction = 'none';
...
function Snake(numSegments, posX, posY){
  ...
  this.update = function(){
    ...
    if (this.deadState == 'dead') {
    	snake = new Snake(5, canvas.width/cellWidth/2-1, canvas.height/cellHeight/2-1);
      direction = 'none'
      score = 0;
...
var amountFood = 3;
var amountWalls = 3;
var snake = new Snake(5, canvas.width/cellWidth/2-1, canvas.height/cellHeight/2-1);
